...
This add-on implements `stream.ConfigurableHardwareEncoder` (see [`../../../../core/MODULE_STREAM_PARAMS.md`](../../../../core/MODULE_STREAM_PARAMS.md)). Intel oneVPL (QSV) supports `MFXVideoENCODE_Reset` for hot reconfiguration of some parameters, but resolution and profile changes require full session teardown.
