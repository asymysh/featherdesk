...
authenticated on its control stream (see [`MODULE_AUTH.md`](../core/MODULE_AUTH.md)),
...
module's `ServeStream`, which receives the stream positioned **after** the tag
