...
> decision. v1 ships the zero-install browser client ([`MODULE_CLIENT.md`](./MODULE_CLIENT.md));
...
The native client speaks the **exact** protocol in [`MODULE_PROTOCOL.md`](./MODULE_PROTOCOL.md)
...
client simply never sends them. Co-op player slots ([`MODULE_GAMEPAD.md`](./MODULE_GAMEPAD.md))
work identically.
...
([`MODULE_STREAM_PARAMS.md`](./MODULE_STREAM_PARAMS.md)) doesn't fall back. This is
