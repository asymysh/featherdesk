...
- **Commit:** 71e1084
- **Changes:** Created Go module (`github.com/aseem/featherdesk`), project directory layout (`cmd/server/`, `internal/{capture,encode,server,protocol}/`, `client/`), Makefile with standard targets, `.gitignore`, and minimal main.go entrypoint.
